import { T, K as K$1, J as J$1, t as te$1 } from './ContentInner-7JU-5FcA.mjs';
import Qe from './Icon-QwMdsGlg.mjs';
import { p } from './nuxt-link-BfTR7asS.mjs';
import { v as $e$1, l as ot, u as Ln, g as ut, s as Pr } from './server.mjs';
...
import { t as te$2, M as et, D as Dn, b, i, x as xi, H as Hn, k as N, a as a$1, P as ie$1, Y as Y$1, d as vn, N as Ni, Z as Z$1, q as q$1, X as X$1, g as gi, e as cr, W as W$1, Q as oe$1, m as _i, U as U$1, y as yn, z as cn, E as xo, L as Hi } from './firstNotUndefined-B1644V9y.mjs';
...
const re = $e$1.defineComponent({ compatConfig: { MODE: 3 }, name: "Tooltip", inheritAttrs: false, props: { trigger: cr.any.def(["hover"]), defaultVisible: { type: Boolean, default: void 0 }, visible: { type: Boolean, default: void 0 }, placement: cr.string.def("right"), transitionName: String, animation: cr.any, afterVisibleChange: cr.func.def(() => {
  ...
  const a2 = $e$1.shallowRef(), i2 = () => {
    ...
    return [e2.arrow ? $e$1.createVNode("div", { class: `${t3}-arrow`, key: "arrow" }, [U$1(o2, e2, "arrowContent")]) : null, $e$1.createVNode(te, { key: "content", prefixCls: t3, id: r3, overlayInnerStyle: n3 }, { overlay: o2.overlay })];
  };
...
} }), ne = () => ({ trigger: [String, Array], open: { type: Boolean, default: void 0 }, visible: { type: Boolean, default: void 0 }, placement: String, color: String, transitionName: String, overlayStyle: oe$1(), overlayInnerStyle: oe$1(), overlayClassName: String, openClassName: String, prefixCls: String, mouseEnterDelay: Number, mouseLeaveDelay: Number, getPopupContainer: Function, arrowPointAtCenter: { type: Boolean, default: void 0 }, arrow: { type: [Boolean, Object], default: true }, autoAdjustOverflow: { type: [Boolean, Object], default: void 0 }, destroyTooltipOnHide: { type: Boolean, default: void 0 }, align: oe$1(), builtinPlacements: oe$1(), children: Array, onVisibleChange: Function, "onUpdate:visible": Function, onOpenChange: Function, "onUpdate:open": Function }), ae = { adjustX: 1, adjustY: 1 }, le = { adjustX: 0, adjustY: 0 }, ie = [0, 0];
function se(e2) {
...
const fe = (e2) => {
...
}, me = te$2($e$1.defineComponent({ compatConfig: { MODE: 3 }, name: "ATooltip", inheritAttrs: false, props: N(a$1(a$1({}, ne()), { title: cr.any }), { trigger: "hover", align: {}, placement: "top", mouseEnterDelay: 0.1, mouseLeaveDelay: 0.1, arrowPointAtCenter: false, autoAdjustOverflow: true }), slots: Object, setup(e2, t2) {
  ...
  return () => {
    ...
    return p2($e$1.createVNode(me, i(i(i({}, Hn(e2, ["title", "content"])), n2), {}, { prefixCls: i2.value, ref: a2, overlayClassName: t3, transitionName: xi(c2.value, "zoom-big", e2.transitionName), "data-popover-inject": true }), { title: u2, default: r2.default }));
  };
} })), ye = {};
const xe = ye.setup;
ye.setup = (e2, t2) => {
...
const $e = o(ye, [["ssrRender", function(e2, t2, o2, r2) {
  const s2 = we, p2 = Qe, d2 = p;
  t2(`<div${Pr.ssrRenderAttrs($e$1.mergeProps({ class: "w-full flex flex-col gap-10" }, r2))}><div class="w-full flex flex-col gap-2"><div class="font-thin text-[16px] text-[#999] leading-none border-b border-dashed pb-2 mb-2"> ABOUT ME </div><div class="w-full flex flex-col gap-2"><div class="w-full h-[220px] bg-[#ccc] rounded-md overflow-hidden"><img class="w-full h-full object-cover"${Pr.ssrRenderAttr("src", a)}></div><div class="flex items-center justify-between gap-2"><span class="text-[18px] font-bold text-[#333]">@\u5C0F\u9EC4\u82B1</span><span class="text-[14px] text-[#666]">\u524D\u7AEF\u5F00\u53D1\u5DE5\u7A0B\u5E08</span></div><div class="italic text-[#999] text-[14px]"> -- \u4ED6\u4E0D\u8FC7\u662F\u6CDB\u9EC4\u6CA1\u4EBA\u7406\u91C7\u7684\u82B1\u6735\u3002 </div><div class="flex items-center justify-between mt-2">`), t2(Pr.ssrRenderComponent(s2, null, { content: $e$1.withCtx((e3, t3, o3, r3) => {
    if (!t3) return [$e$1.createVNode("div", { class: "w-full flex justify-center" }, [$e$1.createVNode("img", { class: "w-40 object-cover", src: s })])];
    t3(`<div class="w-full flex justify-center"${r3}><img class="w-40 object-cover"${Pr.ssrRenderAttr("src", s)}${r3}></div>`);
    ...
    t3(`<div class="w-10 h-10 bg-[#404040] rounded-full flex items-center justify-center hover:bg-primary cursor-pointer"${r3}>`), t3(Pr.ssrRenderComponent(p2, { class: "text-white", name: "ic:baseline-wechat" }, null, o3, r3)), t3("</div>");
  }), _: 1 }, o2)), t2(Pr.ssrRenderComponent(s2, null, { content: $e$1.withCtx((e3, t3, o3, r3) => {
    ...
    t3(`<div class="w-10 h-10 bg-[#404040] rounded-full flex items-center justify-center hover:bg-primary cursor-pointer"${r3}>`), t3(Pr.ssrRenderComponent(p2, { class: "text-white", name: "fa6-brands:weibo" }, null, o3, r3)), t3("</div>");
  }), _: 1 }, o2)), t2(Pr.ssrRenderComponent(d2, { to: "https://github.com/Rupiong", target: "_blank" }, { default: $e$1.withCtx((e3, t3, o3, r3) => {
    ...
    t3(`<div class="w-10 h-10 bg-[#404040] rounded-full flex items-center justify-center hover:bg-primary cursor-pointer"${r3}>`), t3(Pr.ssrRenderComponent(p2, { class: "text-white", name: "akar-icons:github-fill" }, null, o3, r3)), t3("</div>");
  }), _: 1 }, o2)), t2(Pr.ssrRenderComponent(s2, null, { content: $e$1.withCtx((e3, t3, o3, r3) => {
    if (!t3) return [$e$1.createVNode("div", { class: "w-full h-40 bg-[#ccc]" })];
    t3(`<div class="w-full h-40 bg-[#ccc]"${r3}></div>`);
  }), default: $e$1.withCtx((e3, t3, o3, r3) => {
    ...
    t3(`<div class="w-10 h-10 bg-[#404040] rounded-full flex items-center justify-center hover:bg-primary cursor-pointer"${r3}>`), t3(Pr.ssrRenderComponent(p2, { class: "text-white", name: "material-symbols:mail-rounded" }, null, o3, r3)), t3("</div>");
  ...
  const { $onReachBottom: a2 } = ot();
  a2(() => {
  }), Ln();
  const c2 = ut(), u2 = $e$1.ref(null), f2 = $e$1.ref({ isLucency: true, colorClass: "text-white" });
  return T(u2, ([{ isIntersecting: e2 }], t2) => {
    f2.value.isLucency = e2, f2.value.colorClass = e2 ? "text-white" : "text-black";
  }, { threshold: 0 }), (e2, n3, a3, s2) => {
    const p2 = K$1, d2 = J$1, m2 = te$1, g2 = $e;
    n3(`<div${Pr.ssrRenderAttrs($e$1.mergeProps({ class: "w-full h-full relative" }, s2))}><div class="w-full relative">`), n3(Pr.ssrRenderComponent(p2, { isLucency: $e$1.unref(f2).isLucency, colorClass: $e$1.unref(f2).colorClass }, null, a3)), n3(Pr.ssrRenderComponent(d2, { class: "w-full" }, { default: $e$1.withCtx((t2, o2, r2, n4) => {
      if (!o2) return [$e$1.createVNode("div", { ref_key: "headerBgRef", ref: u2, class: "relative w-full h-[680px] md:h-[480px] bg-[#ccc] flex flex-col justify-center items-center overflow-hidden text-primary" }, [$e$1.createVNode("div", { class: "text-[38px] lg:text-[56px] font-bold z-10" }, $e$1.toDisplayString($e$1.unref(c2).meta.title), 1), $e$1.createVNode("div", { class: "z-10 text-[14px] font-thin" }, " \u300C" + $e$1.toDisplayString($e$1.unref(c2).meta.slogan) + "\u300D ", 1), $e$1.createVNode("img", { class: "w-full h-full absolute object-cover brightness-50", src: $e$1.unref(c2).meta.headerBgUrl }, null, 8, ["src"])], 512), $e$1.createVNode("div", { class: "w-full mt-[-90px] z-10 flex justify-center" }, [$e$1.createVNode(m2, null, { default: $e$1.withCtx(() => [$e$1.createVNode("div", { class: "w-full bg-white lg:rounded-md p-6 lg:p-16" }, [$e$1.renderSlot(e2.$slots, "default")]), $e$1.unref(c2).meta.showSiderBar ? ($e$1.openBlock(), $e$1.createBlock("div", { key: 0, class: "w-[300px] h-fit shrink-0 bg-white rounded-md p-10 sticky top-20 hidden lg:block" }, [$e$1.createVNode(g2)])) : $e$1.createCommentVNode("", true)]), _: 3 })])];
      o2(`<div class="relative w-full h-[680px] md:h-[480px] bg-[#ccc] flex flex-col justify-center items-center overflow-hidden text-primary"${n4}><div class="text-[38px] lg:text-[56px] font-bold z-10"${n4}>${Pr.ssrInterpolate($e$1.unref(c2).meta.title)}</div><div class="z-10 text-[14px] font-thin"${n4}> \u300C${Pr.ssrInterpolate($e$1.unref(c2).meta.slogan)}\u300D </div><img class="w-full h-full absolute object-cover brightness-50"${Pr.ssrRenderAttr("src", $e$1.unref(c2).meta.headerBgUrl)}${n4}></div><div class="w-full mt-[-90px] z-10 flex justify-center"${n4}>`), o2(Pr.ssrRenderComponent(m2, null, { default: $e$1.withCtx((t3, o3, r3, n5) => {
        if (!o3) return [$e$1.createVNode("div", { class: "w-full bg-white lg:rounded-md p-6 lg:p-16" }, [$e$1.renderSlot(e2.$slots, "default")]), $e$1.unref(c2).meta.showSiderBar ? ($e$1.openBlock(), $e$1.createBlock("div", { key: 0, class: "w-[300px] h-fit shrink-0 bg-white rounded-md p-10 sticky top-20 hidden lg:block" }, [$e$1.createVNode(g2)])) : $e$1.createCommentVNode("", true)];
        o3(`<div class="w-full bg-white lg:rounded-md p-6 lg:p-16"${n5}>`), Pr.ssrRenderSlot(e2.$slots, "default", {}, null, o3, r3, n5), o3("</div>"), $e$1.unref(c2).meta.showSiderBar ? (o3(`<div class="w-[300px] h-fit shrink-0 bg-white rounded-md p-10 sticky top-20 hidden lg:block"${n5}>`), o3(Pr.ssrRenderComponent(g2, null, null, r3, n5)), o3("</div>")) : o3("<!---->");
      }), _: 3 }, r2, n4)), o2("</div>");
    }), _: 3 }, a3)), n3("</div></div>");
  };
} }), Oe = Ce.setup;
...
//# sourceMappingURL=default-CRs3f8u7.mjs.map
