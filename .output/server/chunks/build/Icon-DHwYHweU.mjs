import { _ as Li, v as $e$1, i as at, H as Bn, s as kr } from './server.mjs';
import { s, c as c$1 } from './index-Ovb55fQk.mjs';
...
let y = 0;
const w = { ...f, inline: false }, k = { xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink", "aria-hidden": true, role: "img" }, j = { display: "inline-block" }, O = { backgroundColor: "currentColor" }, S = { backgroundColor: "transparent" }, _ = { Image: "var(--svg)", Repeat: "no-repeat", Size: "100% 100%" }, I = { webkitMask: O, mask: O, background: S };
for (const Ge in I) {
  const e2 = I[Ge];
  for (const t2 in _) e2[Ge + t2] = _[t2];
}
const F = {};
function E(e2) {
...
const z = (t2, n2) => {
  ...
  const { body: m2, width: _2, height: I2 } = t2, z2 = "mask" === r2 || "bg" !== r2 && -1 !== m2.indexOf("currentColor"), C2 = (function(e2, t3) {
  ...
  })(L2) + '")'), width: E(g2.width), height: E(g2.height), ...j, ...z2 ? O : S, ...a2 }, $e$1.h("span", i2);
...
const q = { provider: "", aliases: {}, not_found: {}, ...$ };
function B(e2, t2) {
...
function G(e2, t2) {
  return (function(e3) {
    ...
    if (!B(e3, q)) return null;
    const n2 = t3.icons;
    for (const i2 in n2) {
      const e4 = n2[i2];
      if (!i2 || "string" != typeof e4.body || !B(e4, N)) return null;
    }
    const o2 = t3.aliases || /* @__PURE__ */ Object.create(null);
    for (const i2 in o2) {
      const e4 = o2[i2], t4 = e4.parent;
      if (!i2 || "string" != typeof t4 || !n2[t4] && !o2[t4] || !B(e4, N)) return null;
    }
    return t3;
  })(t2) ? H(t2, (t3, n2) => {
...
function Ie(e2, t2) {
  e2.iconsToLoad ? e2.iconsToLoad = e2.iconsToLoad.concat(t2).sort() : e2.iconsToLoad = t2, e2.iconsQueueFlag || (e2.iconsQueueFlag = true, setTimeout(() => {
    ...
    if (e2.loadIcons && (o2.length > 1 || !i2)) return void _e(e2.loadIcons(o2, n2, t3), (t4) => {
      Se(e2, o2, t4);
    });
    if (i2) return void o2.forEach((o3) => {
      _e(i2(o3, n2, t3), (t4) => {
        Se(e2, [o3], t4 ? { prefix: n2, icons: { [o3]: t4 } } : null);
      });
    });
    ...
    if (s2.length && Se(e2, s2, null), !r2.length) return;
    const c2 = n2.match(T) ? se(t3) : null;
    if (!c2) return void Se(e2, r2, null);
...
$e$1.defineComponent({ inheritAttrs: false, data: () => ({ _name: "", _loadingIcon: null, iconMounted: false, counter: 0 }), mounted() {
  ...
  if (!t2) return Pe(qe, e2);
  let n2 = e2;
  return t2.classes && (n2 = { ...e2, class: ("string" == typeof e2.class ? e2.class + " " : "") + t2.classes.join(" ") }), Pe({ ...D, ...t2.data }, n2);
} });
const Be = $e$1.defineComponent({ __name: "Icon", __ssrInlineRender: true, props: { name: { type: String, required: true }, size: { type: String, default: "" } }, async setup(i2) {
  let c2, a2;
  const l2 = at(), u2 = s(), f2 = i2;
  $e$1.watch(() => {
    var _a;
  ...
  const p2 = Bn("icons", () => ({})), d2 = $e$1.ref(false), h2 = $e$1.computed(() => {
    var _a, _b;
  ...
  return $e$1.watch(h2, w2), !v2.value && ([c2, a2] = $e$1.withAsyncContext(() => w2()), c2 = await c2, a2()), (t2, n2, r2, s2) => {
    d2.value ? n2(`<span${kr.ssrRenderAttrs($e$1.mergeProps({ class: y2.value, style: { width: x2.value, height: x2.value } }, s2))} data-v-a1315a20></span>`) : b2.value ? n2(kr.ssrRenderComponent($e$1.unref(L), $e$1.mergeProps({ icon: b2.value, class: y2.value, width: x2.value, height: x2.value }, s2), null, r2)) : v2.value ? kr.ssrRenderVNode(n2, $e$1.createVNode($e$1.resolveDynamicComponent(v2.value), $e$1.mergeProps({ class: y2.value, width: x2.value, height: x2.value }, s2), null), r2) : (n2(`<span${kr.ssrRenderAttrs($e$1.mergeProps({ class: y2.value, style: { fontSize: x2.value, lineHeight: x2.value, width: x2.value, height: x2.value } }, s2))} data-v-a1315a20>`), kr.ssrRenderSlot(t2.$slots, "default", {}, () => {
      n2(`${kr.ssrInterpolate(i2.name)}`);
    }, n2, r2), n2("</span>"));
  };
} }), Ve = Be.setup;
Be.setup = (t2, n2) => {
  const o2 = $e$1.useSSRContext();
  return (o2.modules || (o2.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt-icon@0.6.10_magicast@0.5.2_vite@7.3.1_@types+node@25.6.0_jiti@2.6.1_sass@1.98.0_te_3c4fa1bf27ed2ba8e278bc748b510121/node_modules/nuxt-icon/dist/runtime/Icon.vue"), Ve ? Ve(t2, n2) : void 0;
};
const Qe = Li(Be, [["__scopeId", "data-v-a1315a20"]]);

export { Qe as default };
//# sourceMappingURL=Icon-DHwYHweU.mjs.map
